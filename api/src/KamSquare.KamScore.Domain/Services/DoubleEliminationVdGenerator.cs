...
/// <summary>
/// Generates a Double Elimination (VD) bracket for exactly 8 teams.
/// Structure: 4 QFs → 2 Winners games → 2 Losers games → 2 Crossover → 2 Grand SFs → 7th Place → Grand Final.
/// Crossover uses cross-bracket pairings; Grand SFs revert to same-half.
/// </summary>
public static class DoubleEliminationVdGenerator
{
        ...
        List<string> teamIds)
    {
        ...
        // R1: Quarter-Finals (4 games, real teams)
        ...
        // R4: Crossover games (2 games, cross-bracket to avoid rematches)
        ...
        // R5: Grand Semi-Finals (2 games, same-half)
