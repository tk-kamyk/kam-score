...
public class PlayoffWithPlacementGeneratorTests
{
    ...
    {
        var games = PlayoffWithPlacementGenerator.Generate(TournamentId, PhaseId, GroupId, []);
    ...
    {
        var games = PlayoffWithPlacementGenerator.Generate(TournamentId, PhaseId, GroupId, ["a"]);
        games.Should().BeEmpty();
    }
